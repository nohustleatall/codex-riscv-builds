...
| --- | --- | --- |
| 0.125.0 | Orange Pi RV2 / `riscv64gc-unknown-linux-gnu` | V8-enabled build with RISC-V seccomp support |
...
```sh
sha256sum codex-0.125.0-orangepi-rv2-riscv64gc-v8
chmod +x codex-0.125.0-orangepi-rv2-riscv64gc-v8
./codex-0.125.0-orangepi-rv2-riscv64gc-v8 --version
```
